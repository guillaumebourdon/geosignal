...
export default function EeatIaExperienceExpertise() {
  return (
    <>
      ...
      <p>Chaque amélioration E-E-A-T profite simultanément à votre positionnement Google et à votre visibilité IA. C'est le rare cas où un seul investissement produit un retour sur deux fronts.</p>
