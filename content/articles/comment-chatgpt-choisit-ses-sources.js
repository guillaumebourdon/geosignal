...
export default function CommentChatgptChoisitSesSources() {
  return (
    <>
      ...
      <InlineCTA href="/">Votre site est-il visible par ChatGPT ? Vérifiez votre score GEO en 30 secondes.</InlineCTA>
