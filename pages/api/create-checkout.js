...
const PRODUCT_STRINGS = {
  ...
  pro: {
    fr: { name: 'Detekia — Audit GEO complet (20 pages)', description: 'Audit GEO sur l\'ensemble du site (20 pages) — score global, patterns transverses, plan d\'action priorisé, bilan page par page, rapport HTML + PDF' },
    en: { name: 'Detekia — Full website GEO audit (20 pages)', description: 'GEO audit across your entire website (20 pages) — global score, cross-page patterns, prioritized action plan, page-by-page review, HTML + PDF report' },
  },
};
