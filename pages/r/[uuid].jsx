...
const REPORT_STRINGS = {
  fr: {
    ...
    upsellDesc: "L'audit complet Detekia analyse vos 10 pages les plus stratégiques, détecte les patterns transverses et produit un plan d'action priorisé pour l'ensemble du site.",
  ...
  en: {
    ...
    upsellDesc: "Detekia's full audit analyzes your 10 most strategic pages, detects cross-page patterns and produces a prioritized action plan for the entire site.",
