  ...
  return (
    <div style={{ background: '#F7F5F2', minHeight: '100vh', fontFamily: 'Georgia, serif' }}>
      ...
      <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '20px 48px', borderBottom: '1px solid #E5E2DC', background: 'rgba(247,245,242,0.95)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, fontSize: 20, fontWeight: 'bold' }}>
        ...
        <div style={{ display: 'flex', gap: 20, alignItems: 'center' }}>
          <span style={{ fontSize: 13, color: '#8A8680', cursor: 'pointer' }}>Comment ça marche</span>
          <span style={{ fontSize: 13, color: '#8A8680', cursor: 'pointer' }}>Tarifs</span>
          <button style={{ fontSize: 13, fontWeight: 600, background: '#1A1916', color: '#F7F5F2', padding: '8px 18px', borderRadius: 8, border: 'none', cursor: 'pointer' }}>Connexion</button>
        </div>
      </nav>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '80px 24px 0', textAlign: 'center' }}>
        ...
        <p style={{ fontFamily: 'monospace', fontSize: 11, color: '#8A8680', marginTop: 10, marginBottom: 60 }}>Analyse gratuite · Résultats en ~20 secondes</p>
      </div>
      ...
      {result && (
        <div style={{ maxWidth: 780, margin: '0 auto', padding: '0 24px 100px' }}>
          ...
          <div style={{ fontFamily: 'monospace', fontSize: 11, color: '#8A8680', letterSpacing: 1.5, textTransform: 'uppercase', marginBottom: 12, marginTop: 28 }}>Recommandations prioritaires</div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {result.recommendations.map((r, i) => (
              <div key={i} style={{ background: '#fff', border: '1px solid #E5E2DC', borderRadius: 12, padding: '16px 20px', display: 'flex', gap: 14, alignItems: 'flex-start' }}>
