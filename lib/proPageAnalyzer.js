...
const PRO_CACHE_PREFIX = 'detekia:pro:v9:page'; // v9: page classification + weighted Pro score
...
async function analyzePage(url, { locale = 'fr', timeoutMs = 250000 } = {}) {
  ...
  try {
    ...
    // Score V2: 7 deterministic criteria = max 100
