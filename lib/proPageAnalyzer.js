...
function postProcessRecommendations(claude, scores) {
  ...
  const absencePatterns = /n['']est pas [eé]valu[eé]|pas d['']information|non [eé]valu[eé]|pas identifi[eé]|aucun signal|not evaluated|not assessed|no data|absent|not found|not detected/i;
