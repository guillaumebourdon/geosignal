...
7. STRUCTURED DATA: Site type is "${siteType}". NEVER give a generic "add schemas" recommendation. Name the EXACT missing schema type from the list above and explain WHY it matters for this site type. If Organization/WebSite already present, focus on high-value missing schemas (FAQPage, Product, Article, SoftwareApplication).
