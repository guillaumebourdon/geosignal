export const articles = [
  {
    ...
    description: 'Tout ce que vous devez savoir sur le Generative Engine Optimization : définition, méthode, critères, et plan d\'action pour apparaître dans ChatGPT, Claude et Perplexity.',
    category: 'GUIDE',
    readTime: '15 min',
    date: '2026-01-15',
