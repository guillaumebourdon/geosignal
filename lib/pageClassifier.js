...
function classifyPage(url, textContent = '', headings = []) {
  ...
  const contentPaths = /\/(blog|article|guide|learn|academy|ressources?|resources?|docs?|documentation|help|support|faq|knowledge|wiki|tutori|how[-_]?to|conseil|astuce|tips|news|actualit|magazine|journal|editorial|library|glossary|glossaire|lexique|informations?)(\/|$|\?)/i;
