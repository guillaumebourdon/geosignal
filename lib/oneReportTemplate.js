...
const S = {
  fr: {
    ...
    why: {
      extractibilite: "L'extractibilite mesure la capacite des IA a extraire des reponses claires et citables de votre contenu. Concretement, est-ce que votre page repond a une question des les premieres phrases, avec des listes et des titres bien structures ? 44,2% des citations IA proviennent des 30 premiers % du texte d'une page (Growth Memo, 2026). L'etude Princeton/KDD 2024 demontre que l'ajout de statistiques et de citations augmente la visibilite IA de 30 a 40%.",
      ...
      crawlabilite: "La crawlabilite IA mesure si les robots des moteurs IA (GPTBot, ClaudeBot, PerplexityBot) peuvent acceder a votre site et lire son contenu. Si votre robots.txt bloque ces robots ou si votre contenu est rendu uniquement en JavaScript, les IA ne peuvent tout simplement pas vous citer. Debloquer les crawlers IA est souvent le quick win le plus rapide, avec un impact visible en 2 a 4 semaines.",
      'donnees structurees': "Les donnees structurees (Schema.org en JSON-LD) sont un langage standardise qui aide les IA a comprendre le contenu de votre page : qui vous etes (Organization), ce que vous vendez (Product, Service), vos questions frequentes (FAQPage). Les pages avec Schema structurees sont citees 3 a 5x plus souvent que le contenu brut (Otterly.AI, 2026).",
  ...
  en: {
    ...
    why: {
      extractibilite: "Extractability measures how easily AI engines can pull clear, citable answers from your content. Does your page answer a question in its opening sentences, with well-structured lists and headings? 44.2% of AI citations come from the first 30% of a page's text (Growth Memo, 2026). The Princeton/KDD 2024 study shows that adding statistics and citations increases AI visibility by 30-40%.",
      ...
      crawlabilite: "AI Crawlability measures whether AI engine bots (GPTBot, ClaudeBot, PerplexityBot) can access your site and read its content. If your robots.txt blocks these bots or your content is rendered only in JavaScript, AI engines simply cannot cite you. Unblocking AI crawlers is often the fastest quick win, with visible impact in 2-4 weeks.",
      'donnees structurees': "Structured Data (Schema.org in JSON-LD) is a standardized language that helps AI understand your page content: who you are (Organization), what you sell (Product, Service), your FAQs (FAQPage). Pages with structured Schema are cited 3-5x more often than raw content (Otterly.AI, 2026).",
