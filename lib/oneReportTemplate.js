...
const CRITERIA_NAMES = {
  fr: {
    ...
    'Extractibilite & reponse directe': 'Citabilité & réponse directe',
    'Crawlabilite IA': 'Accessibilité IA',
    'Donnees structurees': 'Données structurées',
    'Fraicheur & maintenance': 'Fraîcheur & signaux temporels',
  },
  en: {
    ...
    // Legacy
    'Extractibilite & reponse directe': 'Citability & direct answer',
    'Crawlabilite IA': 'AI Accessibility',
    'Donnees structurees': 'Structured data',
    'Fraicheur & maintenance': 'Freshness & timeliness',
  },
};
...
const S = {
  fr: {
    ...
    wellOptimized: 'Ce critere atteint un bon niveau. Consultez le guide technique ci-dessous pour aller plus loin.',
    wellOptimizedPerfect: 'Score maximum atteint. Continuez a maintenir ce niveau.',
    ...
    criteriaPage: {
      ...
      whyImportant: 'C\'est quoi et pourquoi c\'est important',
    ...
    methodology: {
      ...
      howItWorks1: 'Ce rapport est genere par analyse automatisee du DOM de votre page via un <strong>service de scraping specialise pour les IA</strong> et evaluation sur <strong>7 criteres ponderes</strong>.',
      ...
      criteriaH2: 'Les 7 criteres et leur ponderation',
      ...
      criteria: [
        { name: 'Citabilite & reponse directe', weight: '25 pts', measured: 'Answer capsules, front-loading, profondeur de contenu, titres en question, paragraphes modulaires' },
        { name: 'Verifiabilite & preuves', weight: '20 pts', measured: 'Donnees chiffrees sourcees, liens externes, dates, tableaux comparatifs, citations d\'experts' },
        { name: 'Autorite & E-E-A-T', weight: '15 pts', measured: 'Auteur identifie, pages Contact/Legal/A propos, schema Organization, langage definitif' },
        { name: 'Accessibilite IA', weight: '10 pts', measured: 'Bots IA de recherche autorises, indexabilite, contenu suffisant, lang, canonical, sitemap' },
        { name: 'Neutralite editoriale', weight: '10 pts', measured: 'Evalue par IA — ton factuel, absence de superlatifs, langage educatif' },
        { name: 'Presence externe', weight: '10 pts', measured: 'Reseaux sociaux, mentions presse, temoignages, liens sortants, multi-plateforme' },
        { name: 'Fraicheur & signaux temporels', weight: '10 pts', measured: 'Dates de publication, dateModified, copyright a jour, contenu recent' },
      ],
    },
    email: {
    ...
    why: {
      citabilite: "La citabilite mesure la capacite des IA a extraire des passages clairs et auto-suffisants de votre contenu. Un 'answer capsule' (20-50 mots repondant directement a une question sous un H2) est le facteur n1 de citation IA : 72,4% des pages citees par ChatGPT en contiennent (ALM Corp, 2026). 44,2% des citations proviennent des 30 premiers % du texte. Les titres en format question doublent le taux de citation.",
      extractibilite: "La citabilite mesure la capacite des IA a extraire des passages clairs et auto-suffisants de votre contenu. Un 'answer capsule' (20-50 mots repondant directement a une question sous un H2) est le facteur n1 de citation IA : 72,4% des pages citees par ChatGPT en contiennent (ALM Corp, 2026). 44,2% des citations proviennent des 30 premiers % du texte. Les titres en format question doublent le taux de citation.",
      verifiabilite: "La verifiabilite mesure si votre contenu contient des preuves concretes : chiffres sources, liens externes vers des references, dates et donnees factuelles. Les IA ne citent pas les affirmations non etayees. Les pages avec des donnees chiffrees sont citees 2,8x plus souvent que les pages sans donnees verifiables (AirOps, 2026).",
      autorite: "L'autorite E-E-A-T (Experience, Expertise, Authoritativeness, Trustworthiness) mesure la credibilite de votre site et de ses auteurs aux yeux des IA. Qui ecrit ? Quelles sont ses qualifications ? Votre entreprise est-elle identifiable ? L'autorite de domaine est le predicteur n1 des citations IA avec un score SHAP de 0,63 (SE Ranking, 2025).",
      accessibilite: "L'accessibilite IA mesure si les robots de recherche IA (OAI-SearchBot, ChatGPT-User, PerplexityBot, Claude-Web) peuvent acceder a votre contenu. 71% des sites bloquent un bot IA par erreur (Soar.sh, 2026). Distinction critique : bloquer GPTBot (entrainement) n'affecte PAS vos citations ChatGPT Search, mais bloquer OAI-SearchBot vous rend invisible. Debloquer les bots de recherche IA est le quick win le plus rapide.",
      crawlabilite: "L'accessibilite IA mesure si les robots de recherche IA (OAI-SearchBot, ChatGPT-User, PerplexityBot, Claude-Web) peuvent acceder a votre contenu. 71% des sites bloquent un bot IA par erreur (Soar.sh, 2026). Distinction critique : bloquer GPTBot (entrainement) n'affecte PAS vos citations ChatGPT Search, mais bloquer OAI-SearchBot vous rend invisible. Debloquer les bots de recherche IA est le quick win le plus rapide.",
      neutralite: "La neutralite editoriale mesure si votre contenu est factuel et informatif plutot que promotionnel. Les IA deprioritisent les pages qui utilisent des superlatifs non prouves ('le meilleur', 'n1 du marche'). L'etude Princeton montre que la reecriture factuelle du contenu ameliore la visibilite IA de 30 a 40%.",
      presence: "La presence externe mesure votre visibilite en dehors de votre propre site : reseaux sociaux, mentions dans la presse, citations sur d'autres sites, avis clients. 90% des citations IA proviennent de medias earned et owned, pas de placements payants (Edelman, 2026). Reddit est la source n1 pour Perplexity (6,6% des citations).",
      fraicheur: "La fraicheur mesure si votre contenu est regulierement mis a jour et signale comme recent. Les IA privilegient le contenu a jour : 65% des visites de bots IA ciblent du contenu publie dans les 12 derniers mois (Seer Interactive, 2025). Un contenu non mis a jour depuis plus de 6 mois perd progressivement sa citabilite.",
    },
    cases: {
      citabilite: "Go Fish Digital a applique des tactiques de citabilite (answer capsules, front-loading) et a obtenu +83% de conversions depuis les IA et un taux de conversion 25x superieur au search traditionnel. (Go Fish Digital, 2026)",
      extractibilite: "Go Fish Digital a applique des tactiques de citabilite (answer capsules, front-loading) et a obtenu +83% de conversions depuis les IA et un taux de conversion 25x superieur au search traditionnel. (Go Fish Digital, 2026)",
      ...
      accessibilite: "Triangle IP a cree un fichier llms.txt guidant les IA vers ses pages prioritaires. Resultat : 5x plus de trafic IA et une presence sur ChatGPT, Gemini, Perplexity et Copilot. (Concurate/SE Ranking, 2025)",
    ...
    guides: {
      citabilite: "Ajoutez des 'answer capsules' : apres chaque H2, ecrivez 20-50 mots qui repondent directement a la question du titre. C'est le facteur n1 de citation IA (72,4% des pages citees en ont). Reformulez vos H2 en questions ('Comment fonctionne X ?' plutot que 'Nos solutions'). Placez vos infos cles dans les 30 premiers % de la page. Visez des paragraphes de 40-60 mots, auto-suffisants et extractibles.",
      extractibilite: "Ajoutez des 'answer capsules' : apres chaque H2, ecrivez 20-50 mots qui repondent directement a la question du titre. C'est le facteur n1 de citation IA (72,4% des pages citees en ont). Reformulez vos H2 en questions ('Comment fonctionne X ?' plutot que 'Nos solutions'). Placez vos infos cles dans les 30 premiers % de la page. Visez des paragraphes de 40-60 mots, auto-suffisants et extractibles.",
      ...
      accessibilite: "Verifiez votre robots.txt : autorisez les bots de RECHERCHE IA (OAI-SearchBot, ChatGPT-User, PerplexityBot, Claude-Web) — ce sont eux qui generent les citations. Vous pouvez bloquer les bots d'ENTRAINEMENT (GPTBot, ClaudeBot, Google-Extended) sans perdre de visibilite. Assurez-vous que votre contenu est rendu cote serveur (SSR/SSG, pas CSR). Verifiez votre sitemap.xml.",
      crawlabilite: "Verifiez votre robots.txt : autorisez les bots de RECHERCHE IA (OAI-SearchBot, ChatGPT-User, PerplexityBot, Claude-Web) — ce sont eux qui generent les citations. Vous pouvez bloquer les bots d'ENTRAINEMENT (GPTBot, ClaudeBot, Google-Extended) sans perdre de visibilite. Assurez-vous que votre contenu est rendu cote serveur (SSR/SSG, pas CSR). Verifiez votre sitemap.xml.",
  ...
  en: {
    ...
    wellOptimized: 'This criterion reaches a good level. See the technical guide below to go further.',
    wellOptimizedPerfect: 'Maximum score reached. Keep maintaining this level.',
    ...
    criteriaPage: {
      ...
      found: 'What we found',
      whyImportant: 'What it is and why it matters',
    ...
    methodology: {
      ...
      criteriaH2: 'The 7 criteria and their weighting',
    ...
    why: {
      citabilite: "Citability measures how easily AI engines can extract self-contained, citable passages from your content. An 'answer capsule' (20-50 words directly answering a question under an H2) is the #1 citation factor: 72.4% of ChatGPT-cited pages have one (ALM Corp, 2026). 44.2% of citations come from the first 30% of a page. Question-format headings double citation rates.",
      extractibilite: "Citability measures how easily AI engines can extract self-contained, citable passages from your content. An 'answer capsule' (20-50 words directly answering a question under an H2) is the #1 citation factor: 72.4% of ChatGPT-cited pages have one (ALM Corp, 2026). 44.2% of citations come from the first 30% of a page. Question-format headings double citation rates.",
      verifiabilite: "Verifiability measures whether your content contains concrete evidence: sourced numbers, external links to references, dates and factual data. AI engines do not cite unsupported claims. Pages with hard data are cited 2.8x more often than pages without verifiable data (AirOps, 2026).",
      autorite: "Authority E-E-A-T (Experience, Expertise, Authoritativeness, Trustworthiness) measures your site's and authors' credibility in the eyes of AI engines. Who writes the content? What are their qualifications? Is your organization clearly identified? Domain authority is the #1 predictor of AI citations with a SHAP score of 0.63 (SE Ranking, 2025).",
      accessibilite: "AI Accessibility measures whether AI SEARCH bots (OAI-SearchBot, ChatGPT-User, PerplexityBot, Claude-Web) can access your content. 71% of sites accidentally block an AI bot (Soar.sh, 2026). Critical distinction: blocking GPTBot (training) does NOT affect ChatGPT Search citations, but blocking OAI-SearchBot makes you invisible. Unblocking AI search bots is the fastest quick win.",
      crawlabilite: "AI Accessibility measures whether AI SEARCH bots (OAI-SearchBot, ChatGPT-User, PerplexityBot, Claude-Web) can access your content. 71% of sites accidentally block an AI bot (Soar.sh, 2026). Critical distinction: blocking GPTBot (training) does NOT affect ChatGPT Search citations, but blocking OAI-SearchBot makes you invisible. Unblocking AI search bots is the fastest quick win.",
      neutralite: "Editorial Neutrality measures whether your content is factual and informative rather than promotional. AI engines deprioritize pages that use unproven superlatives ('the best', '#1 on the market'). The Princeton study shows that factual rewriting of content improves AI visibility by 30-40%.",
      presence: "External Presence measures your visibility outside your own website: social media, press mentions, citations on other sites, customer reviews. 90% of AI citations come from earned and owned media, not paid placements (Edelman, 2026). Reddit is the #1 source for Perplexity (6.6% of citations).",
      fraicheur: "Freshness measures whether your content is regularly updated and flagged as recent. AI engines favor up-to-date content: 65% of AI bot visits target content published in the last 12 months (Seer Interactive, 2025). Content not updated for 6+ months gradually loses its citation-worthiness.",
    },
    cases: {
      citabilite: "Go Fish Digital applied citability tactics (answer capsules, front-loading) and achieved +83% conversion increase from AI referrals, with a 25x higher conversion rate than traditional search. (Go Fish Digital, 2026)",
      extractibilite: "Go Fish Digital applied citability tactics (answer capsules, front-loading) and achieved +83% conversion increase from AI referrals, with a 25x higher conversion rate than traditional search. (Go Fish Digital, 2026)",
      ...
      accessibilite: "Triangle IP created an llms.txt file guiding AI to its priority pages. Result: 5x more AI traffic and presence on ChatGPT, Gemini, Perplexity and Copilot. (Concurate/SE Ranking, 2025)",
    ...
    guides: {
      citabilite: "Add 'answer capsules': after each H2, write 20-50 words that directly answer the heading question. This is the #1 AI citation factor (72.4% of cited pages have one). Reformat your H2s as questions ('How does X work?' rather than 'Our solutions'). Put your key info in the first 30% of the page. Aim for 40-60 word paragraphs that are self-contained and extractable.",
      extractibilite: "Add 'answer capsules': after each H2, write 20-50 words that directly answer the heading question. This is the #1 AI citation factor (72.4% of cited pages have one). Reformat your H2s as questions ('How does X work?' rather than 'Our solutions'). Put your key info in the first 30% of the page. Aim for 40-60 word paragraphs that are self-contained and extractable.",
      ...
      accessibilite: "Check your robots.txt: allow AI SEARCH bots (OAI-SearchBot, ChatGPT-User, PerplexityBot, Claude-Web) — these are what generate citations. You can block TRAINING bots (GPTBot, ClaudeBot, Google-Extended) without losing visibility. Make sure your content is server-rendered (SSR/SSG, not CSR). Verify your sitemap.xml is up to date.",
...
function criterionGroup(name, t) {
  if (/citabilit|accessibilit|extractibilit|crawlabilit|donn.*structur/i.test(name)) return t.criterionGroup.readability;
...
function recoSections(reco, t, criterionScore) {
  if (!reco) {
    const isPerfect = criterionScore && criterionScore.score === criterionScore.max;
    const msg = isPerfect ? t.wellOptimizedPerfect : t.wellOptimized;
    return `<div style="background:rgba(16,163,127,0.06);border:1px solid rgba(16,163,127,0.2);border-radius:8px;padding:16px 20px;display:flex;align-items:center;gap:12px;">
      ...
      <span style="font-family:system-ui;font-size:13px;color:#10A37F;font-weight:500;">${msg}</span>
    </div>`;
  }
  ...
  if (reco.problem) {
    ...
    const techCodeGroup = (techBlock || codeBlock)
      ? `<div class="tech-code-group" style="break-inside:avoid;page-break-inside:avoid;">${techBlock}${codeBlock}</div>`
      : '';

    return badges + problemBlock + solutionBlock + techCodeGroup;
  }
   ...
   try {
    ...
    const recosHTML = recos.length > 0
      ? recos.map((reco, ri) => {
          ...
          // Section label + criterion context for continuation pages
          const sectionLabel = ri === 0
            ...
            : `<div style="font-family:monospace;font-size:8px;color:#D5D2CE;letter-spacing:1.5px;text-transform:uppercase;margin-bottom:4px;">${esc(group)} · ${esc(translateCriterionName(c.name, locale))} (suite)</div>`;
          return `<div class="reco-block">${sectionLabel}${header}${reco.title ? `<div style="font-family:Georgia,serif;font-size:16px;color:${rc.color};margin-bottom:12px;font-weight:bold;">${esc(reco.title)}</div>` : ''}${recoSections(reco, t)}</div>`;
        }).join('<div style="height:1px;background:#E5E2DC;margin:16px 0;"></div>')
      : recoSections(null, t, { score: c.score, max: c.max });
    ...
    <div style="${P}">
      <div style="margin-bottom:28px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:10px;">
          ...
          <span style="font-family:monospace;font-size:9px;color:#8A8680;letter-spacing:2px;text-transform:uppercase;">${t.criteriaPage.criterionOf} ${idx + 1} ${t.criteriaPage.of} 7</span>
        </div>
